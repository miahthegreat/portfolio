...
export function OnboardingDemo() {
  ...
  const fetchResidents = useCallback(async () => {
    ...
    try {
      ...
      if (json.data.length && !residentId) setResidentId(json.data[0].id);
    } catch (e) {
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Manage onboarding tasks by resident. Try completing tasks, editing, and switching views.
          </p>
        </div>
        <Link
      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-2">
            <Label htmlFor="resident" className="text-sm text-muted-foreground">
              Resident
            </Label>
            <Select
              value={residentId}
            ...
            >
              <SelectTrigger id="resident" className="w-[220px]">
